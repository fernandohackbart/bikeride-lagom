...
object ServiceLocatorSimple {

  val Name = "DNSServiceLocatorSimple"

  def props: Props =
    Props(new ServiceLocatorSimple)
...
class ServiceLocatorSimple extends Actor with ActorSettings with ActorLogging {

  import ServiceLocatorSimple._
